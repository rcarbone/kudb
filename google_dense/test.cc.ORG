...
typedef google::dense_hash_map<unsigned, int, __gnu_cxx::hash<unsigned> > inthash;
typedef google::dense_hash_map<const char*, int, __gnu_cxx::hash<const char*>, eqstr> strhash;
